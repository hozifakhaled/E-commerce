            ...
            children: [
              ...
              ClipRRect(
                ...
                child: Container(
                  ...
                  child:profileEntitiey.image==''?Image.asset(
                    Assets.imagesTrangs,
                    fit: BoxFit.contain,
                  ):CachedNetworkImage(imageUrl: profileEntitiey.image,fit: BoxFit.contain,),
                ),
              ),
              ...
              Positioned(
                ...
                child: InkWell(
                  onTap: () {
                    context.read<ProfileCubit>().addimage(profileEntitiey.email.toString(),profileEntitiey);
                  },
                  child: Container(
                    decoration: BoxDecoration(
                        border:
